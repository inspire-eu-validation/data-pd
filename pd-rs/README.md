# Conformance class: Reference systems, Population Distribution
...
| ------------- | ----------------- | ---------------- | ---------- |
| [TG DS-PD](#ref_TG_DS_PD) | [GML application schema, Population Distribution](../pd-gml/README.md) | INSPIRE spatial data set encoded in GML, Population Distribution features | n/a |
