...
* Validate each document against the latest INSPIRE official schema(s): https://inspire.ec.europa.eu/schemas/pd/4.0/PopulationDistributionDemography.xsd, using strict XML schema validation.
